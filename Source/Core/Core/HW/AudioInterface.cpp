...
void Init()
{
  ...
  s_cpu_cycles_per_sample = SystemTimers::GetTicksPerSecond() * Mixer::FIXED_SAMPLE_RATE_DIVIDEND /
  ...
  mmio->Register(
      ...
      MMIO::ComplexWrite<u32>([](u32, u32 val) {
        ...
        if (tmp_ai_ctrl.AISFR != s_control.AISFR)
        {
          ...
          s_cpu_cycles_per_sample = SystemTimers::GetTicksPerSecond() *
                                    Mixer::FIXED_SAMPLE_RATE_DIVIDEND / s_ais_sample_rate_divisor;
        }
